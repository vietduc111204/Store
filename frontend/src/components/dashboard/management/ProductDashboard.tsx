        ...
        <tbody>
          {pageRows.map((product) => (
            <tr className="border-t border-slate-100" key={product.maSanPham}>
              ...
              <td className="px-6 py-4 font-bold">{formatMoney(product.gia)}</td>
              <td className="px-6 py-4">
              ...
              <td className="px-6 py-4">
                <span className="rounded-full bg-blue-100 px-4 py-2 text-sm font-bold text-slate-800">{Number(product.soLuong) > 0 ? "Đang bán" : "Hết hàng"}</span>
              </td>
