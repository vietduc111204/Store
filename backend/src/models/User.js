...
const accountSelect = `
  ...
  kh."tenTinhThanh" as "tenTinhThanhKhachHang",
  kh."tenQuanHuyen" as "tenQuanHuyenKhachHang",
  kh."tenPhuongXa" as "tenPhuongXaKhachHang",
  kh."maTinhThanh" as "maTinhThanhKhachHang",
  kh."maQuanHuyen" as "maQuanHuyenKhachHang",
  kh."maPhuongXa" as "maPhuongXaKhachHang",
  nv."tenNhanVien",
